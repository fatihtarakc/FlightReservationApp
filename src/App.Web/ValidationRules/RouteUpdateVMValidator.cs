...
{
    public class RouteUpdateVMValidator : AbstractBaseValidator<RouteUpdateVM>
    {
        public RouteUpdateVMValidator(IStringLocalizer<SharedResources> localizer) : base(localizer)
        {
