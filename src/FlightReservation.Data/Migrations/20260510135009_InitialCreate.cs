        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessRowCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnLetter = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PnrCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    FlightId = table.Column<int>(type: "int", nullable: false),
                    SeatId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PassengerFirstName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PassengerLastName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PassengerIdentityNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_FlightId_SeatId",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routes_OriginCode_DestinationCode",
                table: "Routes",
                columns: new[] { "OriginCode", "DestinationCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Seats_AircraftId_RowNumber_ColumnLetter",
                table: "Seats",
                columns: new[] { "AircraftId", "RowNumber", "ColumnLetter" },
                unique: true);
        }
