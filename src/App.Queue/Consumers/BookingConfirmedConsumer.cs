    ...
    <div style=""padding:30px;"">
      ...
      <div style=""margin:20px 0;padding:20px;background-color:#f0f5ff;border-radius:6px;border:1px solid #d0e4ff;"">
        ...
        <table style=""width:100%;border-collapse:collapse;"">
          ...
          <tr><td style=""color:#777;padding:6px 0;"">{_localizer[Messages.Email_Label_Seat]}</td><td style=""color:#222;font-weight:bold;text-align:right;"">{message.SeatNumber} ({message.SeatClass})</td></tr>
          <tr style=""border-top:1px solid #d0e4ff;""><td style=""color:#003580;padding:10px 0 0;font-weight:bold;"">{_localizer[Messages.Email_Label_TotalAmount]}</td><td style=""color:#003580;font-weight:bold;text-align:right;padding-top:10px;font-size:18px;"">{message.TotalPrice:C2}</td></tr>
        </table>
      </div>
