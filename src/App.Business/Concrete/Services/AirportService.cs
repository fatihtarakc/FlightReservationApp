...
namespace App.Business.Concrete.Services
{
    public class AirportService : IAirportService
    {
        ...
        public async Task<IDataResult<AirportDto>> AddAsync(AirportAddDto dto)
        {
            ...
            {
                Name = dto.Name, IataCode = dto.IataCode, IcaoCode = dto.IcaoCode,
                City = dto.City, Country = dto.Country, TimeZone = dto.TimeZone,
            ...
            return new SuccessDataResult<AirportDto>(airport.Adapt<AirportDto>(), _localizer[Messages.Airport_HasBeen_Added]);
        }
        ...
        public async Task<IResult> UpdateAsync(Guid id, AirportUpdateDto dto)
        {
            ...
            return new SuccessResult(_localizer[Messages.Airport_Was_Updated]);
        }
        ...
        public async Task<IResult> DeleteAsync(Guid id)
        {
            ...
            return new SuccessResult(_localizer[Messages.Airport_Was_Deleted]);
        }
    }
}
